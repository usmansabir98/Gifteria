  ...
  componentDidMount(){
    ...
    axios.get(`/api/all/productcategories`).then(response => {
        this.setState({
            ...
            product_category: response.data[0].name
        });
        ...
        <Grid fluid>
          <Row>
            <Col md={12}>
              <Card
                title="Product"
                category="Create a new product"
                ctTableFullWidth
                ctTableResponsive
                content={
                    <form onSubmit={(values) => this.handleSubmit(values)} style={{padding: '20px'}}>
                        <FormGroup
                            controlId="name">
                        ...
                        <FormGroup controlId="brand">
                            ...
                            value={this.state.brand} name="brand"
                            onChange={this.handleChange}
                            >
                            {
                        ...
                        <FormGroup controlId="product_category">
                            ...
                            <FormControl componentClass="select" placeholder="select" 
                            value={this.state.product_category} name="product_category"
                            onChange={this.handleChange}
                            >
                            {
